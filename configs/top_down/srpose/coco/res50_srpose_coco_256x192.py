...
model = dict(
    type='TopDownHigher',
    pretrained='/path/to/pretrain_model/resnet50-19c8e357.pth', #'/pretrain_model/resnet50-19c8e357.pth',
    backbone=dict(type='ResNet', depth=50, out_indices=(0,1,2,3)),
    keypoint_head=dict(
        type='TopDownSRPoseHead',
...
data_root = '/path/to/data/coco' #'../../../../dataset/coco'
data_cfg = dict(
    image_size=[192, 256],
